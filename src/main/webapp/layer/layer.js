...
;!function (a, b) {
    ...
    h.anim = ["layer-anim", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], g.pt.config = {
        ...
        var c = this, d = c.index, f = c.config, g = f.zIndex + d,
        ...
        var a = this, b = a.config, g = a.index, i = b.content,
            j = "object" == typeof i;
        if (!c("#" + b.id)[0]) {
        ...
        var a = this, b = a.config, e = a.layero,
            f = [e.outerWidth(), e.outerHeight()], g = c(b.follow);
        g[0] || (g = c("body"));
        var i = {
            width: g.outerWidth(),
        ...
        if (a) {
            var b = f.getChildFrame("html", a).outerHeight(),
                d = c("#" + h[0] + a), e = d.find(h[1]).outerHeight() || 0,
